...
public class JButtonDemo extends JPanel implements ActionListener {
	...
	public JButtonDemo() {
		...
		ImageIcon leftButtonIcon = createImageIcon("java.png");
		ImageIcon middleButtonIcon = createImageIcon("java.png");
		ImageIcon rightButtonIcon = createImageIcon("java.png");
